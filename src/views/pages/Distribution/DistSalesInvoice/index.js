...
import AddDistInvoice from './AddDistInvoice';
import DistInvoiceRow from './DistInvoiceRow';
...
import { useGetDistInvoicesQuery } from 'store/api/distInvoice/distInvoiceApi';

const DistSalesInvoice = () => {
  ...
  const { data, isLoading } = useGetDistInvoicesQuery(
    { ...query },
    { refetchOnMountOrArgChange: true }
  );

  const allInvoices = data?.distInvoices || [];
...
export default DistSalesInvoice;
