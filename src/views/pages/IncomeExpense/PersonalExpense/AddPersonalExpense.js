...
import { useCreateIncomeExpenseMutation } from 'store/api/incomeExpense/incomeExpenseApi';
import moment from 'moment';
import AddInExCategory from '../InExCategory/AddInExCategory';
import AddModeOfPayment from '../ModeOfPayment/AddModeOfPayment';
import AddExpenseHead from '../ExpenseHead/AddExpenseHead';
...
const AddPersonalExpense = ({ open, handleClose }) => {
  ...
  const [createIncomeExpense] = useCreateIncomeExpenseMutation();
  ...
  const onSubmit = async (data) => {
    ...
    try {
      setLoading(true);
      const res = await createIncomeExpense({ ...newData }).unwrap();
      if (res.success) {
        handleClose();
        setLoading(false);
        reset();
