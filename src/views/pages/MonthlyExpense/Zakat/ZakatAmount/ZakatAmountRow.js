...
import UpdateZakatAmount from './UpdateZakatAmount';

const ZakatAmountRow = ({ sn, data }) => {
      ...
      if (res.success) {
        dispatch(
          setToast({
            open: true,
            variant: 'success',
            message: 'Zakat Amount Deleted Successfully',
          })
        );
      }
    } catch (err) {
