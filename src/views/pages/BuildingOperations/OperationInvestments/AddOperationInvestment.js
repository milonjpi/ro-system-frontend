...
import { useCreateBuildingInvestmentMutation } from 'store/api/buildingInvestment/buildingInvestmentApi';
...
const AddOperationInvestment = ({ open, handleClose }) => {
  ...
  const [createBuildingInvestment] = useCreateBuildingInvestmentMutation();
  ...
  const onSubmit = async (data) => {
    ...
    try {
      setLoading(true);
      const res = await createBuildingInvestment({ ...newData }).unwrap();
...
export default AddOperationInvestment;
