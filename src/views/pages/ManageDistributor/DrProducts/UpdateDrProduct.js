...
import { useUpdateDrProductMutation } from 'store/api/drProduct/drProductApi';
...
const UpdateDrProduct = ({ open, handleClose, preData }) => {
  ...
  const [updateDrProduct] = useUpdateDrProductMutation();
  ...
  const onSubmit = async (data) => {
    ...
    try {
      setLoading(true);
      const res = await updateDrProduct({
        id: preData?.id,
        body: newData,
      }).unwrap();
      if (res.success) {
...
export default UpdateDrProduct;
